...
/** @defgroup CM3_nvic_isrpragmas_LPC43xx (M4) User interrupt service routines (ISR) defaults for LPC 43xx series M4 core (rev_1_7_UM10503)
...
#pragma weak flasheeprom_isr = blocking_handler
...
#pragma weak adchs_isr = blocking_handler
...
#define IRQ_HANDLERS \
    ...
    [NVIC_FLASHEEPROM_IRQ] = flasheeprom_isr, \
